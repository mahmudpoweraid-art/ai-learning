...
const Chatbot: React.FC = () => {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
        ...
        const response = await chatProxy.sendMessage(chatHistory, input);

        const translatedText = await geminiService.translateContent(response.text, language);
        const modelMessage: ChatMessage = { role: 'model', text: translatedText };
