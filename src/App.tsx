...
const TopicsListView = lazy(() => import('./components/TopicsListView'));
const TopicIndex = lazy(() => import('./components/TopicIndex'));
...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary p-4 sm:p-6 lg:p-8 flex flex-col">
      ...
      <footer className="text-center text-text-secondary py-4 mt-8 border-t border-gray-700">
          <p>{t('developed_by')}</p>
      </footer>
      <Chatbot />
      <AudioTranscriber />
